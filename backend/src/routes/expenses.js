...
router.post('/', wrapAsync(async (req, res) => {
    ...
    await ExpensesService.create(req.body.data, req.currentUser, true, link.host);
    const payload = true;
...
router.get('/', wrapAsync(async (req, res) => {
  ...
  const payload = await ExpensesDBApi.findAll(
...
router.get('/:id', wrapAsync(async (req, res) => {
  const payload = await ExpensesDBApi.findBy(
    { id: req.params.id },
  );
