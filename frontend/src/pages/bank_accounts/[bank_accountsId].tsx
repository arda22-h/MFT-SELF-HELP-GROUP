...
const EditBank_accounts = () => {
  ...
  const { bank_accountsId } = router.query

  useEffect(() => {
    dispatch(fetch({ id: bank_accountsId }))
  }, [bank_accountsId])
  ...
  const handleSubmit = async (data) => {
    await dispatch(update({ id: bank_accountsId, data }))
...
EditBank_accounts.getLayout = function getLayout(page: ReactElement) {
  return (
      <LayoutAuthenticated>
          {page}
      </LayoutAuthenticated>
...
export default EditBank_accounts
