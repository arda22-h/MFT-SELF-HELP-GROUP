...
const EditContributions = () => {
  ...
  const { contributionsId } = router.query

  useEffect(() => {
    dispatch(fetch({ id: contributionsId }))
  }, [contributionsId])
  ...
  const handleSubmit = async (data) => {
    await dispatch(update({ id: contributionsId, data }))
...
EditContributions.getLayout = function getLayout(page: ReactElement) {
  return (
      <LayoutAuthenticated>
          {page}
      </LayoutAuthenticated>
