...
const EditWelfare_contributionsPage = () => {
...
EditWelfare_contributionsPage.getLayout = function getLayout(page: ReactElement) {
  return (
      <LayoutAuthenticated>
          {page}
      </LayoutAuthenticated>
...
export default EditWelfare_contributionsPage
