...
import { create } from '../../stores/welfare_contributions/welfare_contributionsSlice'
...
const Welfare_contributionsNew = () => {
...
Welfare_contributionsNew.getLayout = function getLayout(page: ReactElement) {
  return (
      <LayoutAuthenticated>
          {page}
      </LayoutAuthenticated>
...
export default Welfare_contributionsNew
